...
from .views import create_user, login_user, logout_user, RegisterConfirm2Ways
...
urlpatterns = patterns('',
	...
	url(r'^account_verification/$', RegisterConfirm2Ways.as_view(success_url='aaa'), name='account_verification'),
